    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert([{
          ...
          physical_limitations: answers.physicalLimitations,
          current_conditioning: answers.currentConditioning,
          current_frequency: answers.currentFrequency,
          main_objective: answers.mainObjective,
          nutrition: answers.nutrition,
          hydration: answers.hydration,
          sleep: answers.sleep,
          main_motivation: answers.mainMotivation,
        }]);
